...
- 2026-07-22 japanese-tech-writing を skills/<name>/SKILL.md 形式でスキル化、本文は upstream Gist の verbatim ミラー / 却下: 素 markdown 維持 — ユーザー確認済み ([議事録](LOGS/2026-07-22_japanese-tech-writing-conversational.md))
- 2026-07-22 管理方式は curl 上書きミラー + 出自コメント / 却下: リポジトリ化 fork、submodule 化 — ユーザー確認済み ([議事録](LOGS/2026-07-22_japanese-tech-writing-conversational.md))
- 2026-07-22 cognitive-rhythm-writing を姉妹スキルとして追加 (兄弟ディレクトリ配置) / 却下: 追加しない — ユーザー確認済み ([議事録](LOGS/2026-07-22_japanese-tech-writing-conversational.md))
- 2026-07-22 会話応答への適用は @import + UserPromptSubmit フック毎ターン注入の併用 / 却下: @import 単独、フック単独、description 書換 — ユーザー確認済み ([議事録](LOGS/2026-07-22_japanese-tech-writing-conversational.md))
- 2026-07-22 効果検証は成果物の機械検査 (禁止字面カウント + JSONL 機構検査) / 却下: モデル自己申告 — ユーザー確認済み ([議事録](LOGS/2026-07-22_japanese-tech-writing-conversational.md))
- 2026-07-22 実運用への試験投入を採用 (失敗モード対抗をフック文言に組込) / 却下: 再設計版 EPT を先に実施 — ユーザー確認済み ([議事録](LOGS/2026-07-22_japanese-tech-writing-conversational.md))
