...
## 2026-06-25: Workflow ツール進捗管理節の追加

### 実施内容

`~/.claude/rules/agent-teams.md` に「Progress Management with Workflow」節を追加した。
内容は Workflow ツールの `phase()` / `log()` による進捗追跡の使い方と、TeamCreate との使い分け比較表。
